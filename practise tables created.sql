...
insert into Author values(2,'Thomas Hardy');
insert into Author values(3,'Oscar Wilde');
insert into Author values(4,'Sidney Sheldon');
insert into Author values(5,'Alistair MacLean');
insert into Author values(6,'Jane Austen');
insert into Author values(7,'Chetan Bhagat');
insert into Author values(8,'Oscar Wilde');
select * from author;
